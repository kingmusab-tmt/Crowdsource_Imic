...
import { Notification, View, Member } from '../types';
...
const Header: React.FC<HeaderProps> = ({ currentUser, toggleSidebar, notifications, onMarkViewed, setCurrentView, onLogout }) => {
